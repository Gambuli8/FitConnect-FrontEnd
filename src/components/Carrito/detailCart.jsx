    ...
    <div className='flex'>
      <div className="w-[50%] h-[68vh] flex justify-center items-center text-center bg-gray-700">
            ...
            >
              ...
              className=" h-[100px] items-center flex justify-around text-[20px] bg-gray-700"
            >
              <img className="w-[250px] h-[180px]" src={item.image} alt="" />
              <div className="flex flex-col m-10">
                <h1 className="">Activity: {item.name}</h1>
                <h3 className="m-2">Type Activity: {item.type_activity}</h3>
                <h3>Schedule {item.schedule}</h3>
                <p className="m-2">Duration: {item.schedule}</p>
