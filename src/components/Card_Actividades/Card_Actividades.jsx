function Card_Actividades() {
  return (
    <div className="w-[340px] h-[450px] border-[4px] border-[#ffd277] shadow-black shadow-xl bg-gray-800  flex flex-col rounded-xl justify-center items-center m-4 bg-auto bg-no-repeat bg-center bg-origin-padding hover:translate-y-[-20px] duration-300">
      <div className="flex flex-col text-justify p-2 items-center text-white">
        ...
        <p className="font-Inconsolata my-2 text-[17px] font-light capitalize text-gray-400">
